...
public class MZG_GetArticle : ITransformation
{
    const String YqlTemplate = "http://query.yahooapis.com/v1/public/yql" + 
        "?q=select%20*%20from%20html%20where%20url%3D'http%3A%2F%2Fmegam" + 
        "ozg.ru%2Fpost%2F{0}'%20and%20xpath%3D'.%2F%2Fdiv%5B%40class%20%3" +
        "D%20%22content%20html_format%22%5D'&format=xml";
    ...
    public IEnumerable<Dictionary<string, string>> Transform(string[] args)
    {
        ...
        catch (Exception ex)
        {
            ...
            exceptionBuilder.AppendLine("Method: " + "MZG_GetArticle");
